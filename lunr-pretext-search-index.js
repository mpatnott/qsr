...
},
{
  ...
  "number": "1.3.3",
  "title": "",
  "body": "   The vertical intercept of a linear model is the value where the graph crosses the vertical axis. It is also called the initial value because it is the output when the input is 0. What is the vertical intercept of your graph in part (e)?    Suppose that Theo used kWh of energy in a summer month. Find a formula for , Theo's bill.    How do the slope and vertical intercept of the linear model appear in your formula in part (b)?    Write a sentence describing how to build a formula to find the output of a linear model from its slope, vertical intercept, and an input value.   "
},
{
