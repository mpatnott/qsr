...
{
  "id": "sec-math-models-4-1",
  "level": "2",
  "url": "sec-math-models.html#sec-math-models-4-1",
  "type": "Activity",
  "number": "1.1.4",
  "title": "",
...
{
  "id": "sec-linear-trends-3-1",
  "level": "2",
  "url": "sec-linear-trends.html#sec-linear-trends-3-1",
  "type": "Activity",
  "number": "1.4.2",
  "title": "",
...
{
  "id": "sec-linear-trends-4-1",
  "level": "2",
  "url": "sec-linear-trends.html#sec-linear-trends-4-1",
  "type": "Activity",
  "number": "1.4.3",
  "title": "",
...
{
  "id": "sec-linear-trends-5-1",
  "level": "2",
  "url": "sec-linear-trends.html#sec-linear-trends-5-1",
  "type": "Activity",
  "number": "1.4.4",
  "title": "",
...
},
{
  ...
  "number": "1.5.1",
  "title": "",
  "body": "  In , we explored the cost of electricity in and around Denver, CO, during the summer for customers on the Residential Opt-Out Pricing Plan. We knew that the rates for this plan are .   Xcel Energy Electricity Charges, Residential Opt-Out Pricing     Summer Billing Cycles (June - Septembr)  Winter Billing Cycles    Fixed Monthly Fees  $12.20  $12.20    $ Per kWh  $0.1038  $0.0857     And used this information to find that is a linear model for the bill amount of a customer that uses kWh.    Now, let's consider the cost of electricity in and around Denver in the winter. Use the information given in the table above to build a linear model for the bill amount, , of a customer that uses kWh in the winter.    The company that provides electricity to people in and around New Orleans, Louisiana is called Entergy. The table below estimates the winter monthly rates charged by Entergy . Let be the monthly bill amount and be the number of kWh used.   Entergy Electricity Charges, November - April    Fixed Monthly Fees  $8.07    Cost per kWh, for 800 kWh or less  $0.06002    Cost per kWh, kWh over 800 kWh  $0.04766     For example, a customer who used 700 kWh in a month would be charged . A customer who used 1000 kWh in a month would be charged    How much would a customer who used 600 kWh be charged? 900 kWh? 1200 kWh?   Build a linear model for the bill , of a customer that used 800 kWh or less.   Build a linear model for the bill , of a customer that used 800 kWh or less.   "
},
{
  "id": "sec-piecewise-linear-3-1",
  "level": "2",
  "url": "sec-piecewise-linear.html#sec-piecewise-linear-3-1",
  "type": "Activity",
  "number": "1.5.2",
  "title": "",
...
{
  "id": "sec-piecewise-linear-4-1",
  "level": "2",
  "url": "sec-piecewise-linear.html#sec-piecewise-linear-4-1",
  "type": "Activity",
  "number": "1.5.3",
  "title": "",
...
{
  "id": "sec-piecewise-linear-5-1",
  "level": "2",
  "url": "sec-piecewise-linear.html#sec-piecewise-linear-5-1",
  "type": "Activity",
  "number": "1.5.4",
  "title": "",
...
{
  "id": "sec-piecewise-linear-6-1",
  "level": "2",
  "url": "sec-piecewise-linear.html#sec-piecewise-linear-6-1",
  "type": "Activity",
  "number": "1.5.5",
  "title": "",
...
},
{
  ...
  "number": "3.1.1",
  "title": "",
  "body": "  The state of Illinois has a 6.25% sales tax.    Calculate the amount of tax on a $120 purchase. Round to the nearest cent.   What is the total sale price of a $120 purchase, including tax? Round to the nearest cent.   Textbooks are taxable in Illinois. The amount that a student paid at her school bookstore was $185. What was the price of the books and school supplies before tax? Round to the nearest cent.    In 2022, Jacob worked as a fast food manager and:   had a taxable income of $30,000  was required to pay $3,398 in federal taxes.   What federal tax rate did Jacob pay as a percentage? Round to the nearest percent.    According to Wikipedia, the information in the table below represents a breakdown of how the U.S. federal government spent money during the 2022 fiscal year: Compute the percentage of the total amount of money that the U.S. federal government spent in each category to complete the table. Round to the nearest percentage point.   US Federal Government Spending, FY 2022    Category  Billions of $ Spent  Percentage of Total Spending    Defense Department  751     Social Security  1,200     Healthcare  1,339     Net Interest  475     Other Mandatory  1,583     Other Discretionary  910        Some research suggests that the risk of developing type 2 diabetes by age 70 is 11%. How could you express this with a meaningful rate or ratio?   "
},
{
  "id": "a-percent-as-rate",
  "level": "2",
  "url": "sec-working-with-percentages.html#a-percent-as-rate",
  "type": "Activity",
  "number": "3.1.2",
  "title": "",
  "body": "  According to the CDC, 11.5% of Americans smoked tobacco in 2021.    What is meant by this statement? What was the numerator? What was the denominator? What assumptions could you make about the population of Americans included in this statement?   Discuss in your group how this percentage (11.5%) was probably computed. Record your group's thinking below.    The Insurance Institute for Highway Safety (IIHS) is an independent, nonprofit scientific and educational organization dedicated to reducing deaths, injuries and property damage from motor vehicle crashes. In 2021, the IIHS published statistics showing, in part, that almost three out of four motor vehicle crash deaths were males.    Use the figures from the last sentence (\"almost three out of four motor vehicle deaths\"). What percentage of motor vehicle crash deaths in the U.S. were males? Round to the nearest percentage point.   What percentage of motor vehicle crash deaths in the U.S. were female? Round to the nearest percentage point.   Do your answers to the previous two parts support the statement, \"In general, males are more likely to be killed in traffic accidents than females\"? Explain your reasoning. Support your answer with some possible examples.   "
},
{
...
},
{
  ...
  "number": "3.2.10",
  "title": "",
  "body": "  One way to systematically look at a large set of relative changes over time is to create an index . We used the Consumer Price Index earlier to help us understand inflation. Now, you'll compute a salary index to help Lucian's career discernment. A salary index will look like a table of numbers that answer the question, \"The salary for this year is what percent of the base year?\"    Use the salary information from the earlier to create a salary index for each of the three positions. You will be creating three separate indices, one for Sales Associate, one for Sales Supervisor, and one for Regional Sales Manager. Use 2016 as the base year, and round each answer to the nearest tenth.   Salary Index (Base Year = 2016)    Year  Sales Associate  Sales Supervisor  Regional Sales Manager    2016       2017       2018       2019       2020       2021       2022       2023          Use quantities in your index table to explain your observations and ideas about what Gary should know about how the salaries change over time.    Make a graph of the indices that you created. What are the advantages and disadvantages of using this graph to interpret how the salaries changed over time?   Salary Indexes of Sales Personnel (2016 - 2023)    Blank axes. The horizontal axis is labeled the years between 2016 and 2023. The vertical axis is labeled from 90 to 115 in increments of 5.   Blank axes.      "
},
{
...
},
{
  ...
  "body": " Exponential Trends    We saw in that in the real world, it's more common to have data that is approximately linear than it is to have data that is exactly . The same thing is true of exponential models! Today, we will put the skills we've been learning together to find a formula for an exponential model for a data set with an exponential trend.     The graph on the left below Chart made in Excel using data from: Hannah Ritchie, Lucas Rodés-Guirao, Edouard Mathieu, Marcel Gerber, Esteban Ortiz-Ospina, Joe Hasell and Max Roser (2023) - \"Population Growth\" Published online at OurWorldInData.org. Retrieved from: [Online Resource] shows population of what is now the United States between 1700 and 2023.   US Population Between 1700 and 2023.    Population   Graph showing the population in what is now the US between 1700 and 2023.   The population appears to have grown exponentially, from a little under a million people in 1700 to about 343 million in 2023.      Log of US Population Between 1700 and 2023.   Graph showing the log of the population in what is now the US between 1700 and 2023..   The log of the population is roughly linear. It seems to be about 5.95 in 1700, and about 8.54 in 2023.         Explain why a linear model is not a good fit for the population data.    The trend of the data resembles the graphs of an increasing exponential model. Logs are often used to analyze trends when the data seems to grow exponentially. The graph above right shows the log of the population. The years are kept the same, but the vertical axis shows the log of the population instead of the population itself. A graph that takes the log of the data values on one of the two axes is called a semi-log graph .  Explain why a linear model IS a good fit for the log of the population data.    We can use either graph to estimate the US population in a year. For example, we see from the population data graph that the US population in 1990 was about 250 million. From the log population graph, we see that the log of the population in 1990 was about 8.4. If we let be the population, we get the log equation . As we learned in , this tells us that , which is about 250 million.  Estimate the US population in 1930 in two ways: (1) from the population data graph and (2) from the log of population data graph.        Here's the log of population graph again.   Log of US Population Between 1700 and 2023.   Graph showing the log of the population in what is now the US between 1700 and 2023.   The log of the population is roughly linear. It seems to be about 5.95 in 1700, and about 8.54 in 2023.     Sketch a line on the graph to model the trend, and find a formula for your line.    If is the population of the US, then the output of your line is . To transform your linear model for into an exponential model for , apply the \"raise 10 to the power of...\" operation to both sides of your line formula.    Use your exponential model for to estimate the US population in 1930 and 1990. How close are your answers to our earlier estimates?    Summarize the process that we used in this activity and to find an exponential model or a data set.        The graphs below show   US Child Mortality Rate Between 1933 and 2021.    Child Mortality Rate   Graph showing the child mortality rate in the US between 1933 and 2021.   The child mortality rate appears to have decreased exponentially, from nearly 8% in 1934 to about 0.6% in 2021.      Log of Child Mortality Rate   Graph showing the log of the child mortality rate in the US between 1933 and 2021.   The log of the child mortality rate is approximately linear. It's about 0.9 in 1934 and about -0.2 in 2021.         Explain why a linear model is a better fit for the log of the child mortality rate than the child mortality rate.    Find a formula for a linear model for the log of the child mortality rate.    Find a formula for an exponential model for the child mortality rate.    Use your exponential model for the child mortality rate to estimate it in 1940, 1995, and 2025. What do you notice? What do you wonder?         The table below shows the cost in dollars per megabyte of storage space on computer hard drives from 1980 to 2004.   Cost Per Megabyte of Storage Space    Year  1980  1984  1988  1992  1996  2000  2004    Cost per MB ($)  192.31  87.86  15.98  4  0.173  0.006849  0.001149       Graph the data on the axes below left. Explain how the graph tells you that an exponential model is probably a better fit than a linear model.    Cost Per Megabyte of Storage Space    Blank axes. The horizontal axis goes from 0 to 24, and the vertical axis goes from 0 to 200.   Blank axes.      Log Cost Per Megabyte of Storage Space    Blank axes. The horizontal axis goes from 0 to 24, and the vertical axis goes from -4 to 3.   Blank axes.        Complete the table below by finding the log of the costs. Then, plot your new points on the axis above right.   Log Cost Per Megabyte of Storage Space    Year  1980  1984  1988  1992  1996  2000  2004    Log Cost per MB ($)              Explain why a linear model seems to be reasonable for the log of costs, then find a formula for a linear model for log costs.    Convert your linear model for log costs into an exponential model for costs.    Use your exponential model for costs to fill in the table below. What do you notice? What do you wonder?   Cost Per Megabyte of Storage Space    Year  1980  1984  1988  1992  1996  2000  2004    Cost per MB ($)  192.31  87.86  15.98  4  0.173  0.006849  0.001149    Estimate Cost From Model                  Graph each of the data sets given below, and use your graph to decide whether a linear model, an exponential model, or neither is a reasonable fit for the trend. If a linear model or exponential model is a reasonable fit for the trend, find a formula for it.    The average price of electricity (in cents per kilowatt hour) from 1990 through 2008 is given below.   Average Electricity Price (cents per kilowatt hour)    Year  1990  1992  1994  1996  1998  2000  2002  2004  2006  2008    Cost  7.83  8.21  8.38  8.36  8.26  8.24  8.44  8.95  10.50  11.26       The average cost of a loaf of white bread from 1986 through 2008 is given below.   Average Cost of a Loaf of White Bread ($)    Year  1986  1988  1990  1995  1997  2000  2002  2004  2006  2008    Cost  0.57  0.66  0.70  0.84  0.88  0.99  1.03  0.97  1.14  1.42        "
},
{
  ...
  "number": "3.5.1",
  "title": "",
  "body": "  The graph on the left below Chart made in Excel using data from: Hannah Ritchie, Lucas Rodés-Guirao, Edouard Mathieu, Marcel Gerber, Esteban Ortiz-Ospina, Joe Hasell and Max Roser (2023) - \"Population Growth\" Published online at OurWorldInData.org. Retrieved from: [Online Resource] shows population of what is now the United States between 1700 and 2023.   US Population Between 1700 and 2023.    Population   Graph showing the population in what is now the US between 1700 and 2023.   The population appears to have grown exponentially, from a little under a million people in 1700 to about 343 million in 2023.      Log of US Population Between 1700 and 2023.   Graph showing the log of the population in what is now the US between 1700 and 2023..   The log of the population is roughly linear. It seems to be about 5.95 in 1700, and about 8.54 in 2023.         Explain why a linear model is not a good fit for the population data.    The trend of the data resembles the graphs of an increasing exponential model. Logs are often used to analyze trends when the data seems to grow exponentially. The graph above right shows the log of the population. The years are kept the same, but the vertical axis shows the log of the population instead of the population itself. A graph that takes the log of the data values on one of the two axes is called a semi-log graph .  Explain why a linear model IS a good fit for the log of the population data.    We can use either graph to estimate the US population in a year. For example, we see from the population data graph that the US population in 1990 was about 250 million. From the log population graph, we see that the log of the population in 1990 was about 8.4. If we let be the population, we get the log equation . As we learned in , this tells us that , which is about 250 million.  Estimate the US population in 1930 in two ways: (1) from the population data graph and (2) from the log of population data graph.   "
},
{
  ...
  "number": "3.5.2",
  "title": "",
  "body": "  Here's the log of population graph again.   Log of US Population Between 1700 and 2023.   Graph showing the log of the population in what is now the US between 1700 and 2023.   The log of the population is roughly linear. It seems to be about 5.95 in 1700, and about 8.54 in 2023.     Sketch a line on the graph to model the trend, and find a formula for your line.    If is the population of the US, then the output of your line is . To transform your linear model for into an exponential model for , apply the \"raise 10 to the power of...\" operation to both sides of your line formula.    Use your exponential model for to estimate the US population in 1930 and 1990. How close are your answers to our earlier estimates?    Summarize the process that we used in this activity and to find an exponential model or a data set.   "
},
{
...
},
{
  ...
  "number": "3.5.4",
  "title": "",
  "body": "   The table below shows the cost in dollars per megabyte of storage space on computer hard drives from 1980 to 2004.   Cost Per Megabyte of Storage Space    Year  1980  1984  1988  1992  1996  2000  2004    Cost per MB ($)  192.31  87.86  15.98  4  0.173  0.006849  0.001149       Graph the data on the axes below left. Explain how the graph tells you that an exponential model is probably a better fit than a linear model.    Cost Per Megabyte of Storage Space    Blank axes. The horizontal axis goes from 0 to 24, and the vertical axis goes from 0 to 200.   Blank axes.      Log Cost Per Megabyte of Storage Space    Blank axes. The horizontal axis goes from 0 to 24, and the vertical axis goes from -4 to 3.   Blank axes.        Complete the table below by finding the log of the costs. Then, plot your new points on the axis above right.   Log Cost Per Megabyte of Storage Space    Year  1980  1984  1988  1992  1996  2000  2004    Log Cost per MB ($)              Explain why a linear model seems to be reasonable for the log of costs, then find a formula for a linear model for log costs.    Convert your linear model for log costs into an exponential model for costs.    Use your exponential model for costs to fill in the table below. What do you notice? What do you wonder?   Cost Per Megabyte of Storage Space    Year  1980  1984  1988  1992  1996  2000  2004    Cost per MB ($)  192.31  87.86  15.98  4  0.173  0.006849  0.001149    Estimate Cost From Model             "
},
{
...
},
{
  ...
  "number": "4.1.2",
  "title": "",
  "body": "Audryn added a $12 tip to a $68.73 restaurant bill. What percent tip did she leave? Round to the nearest tenth of a percent. "
},
{
...
},
{
  ...
  "type": "Section",
  "number": "4.3",
  "title": "Exponential Models Prep Activities",
  "body": " Exponential Models Prep Activities     The population of a small town in Indiana was 5,500 people in the year 2010 and census data showed that the population grew by approximately 2.5% every year until 2020. What was the approximate population in 2011? 2012? 2013? 2020? Round to the nearest person.   Indiana Town Population    Year  2010  2011  2012  2013  2020    Population  5500            The population of a small town in Ohio was 5,500 people in the year 2010 and census data showed that the population decreased by approximately 2.5% every year until 2020. What was the approximate population in 2011? 2012? 2013? 2020? Round to the nearest person.   Ohio Town Population    Year  2010  2011  2012  2013  2020    Population  5500           The population of a small town in Michigan was also 5,500 people in the year 2010, but it decreased by an average of 150 people a year until 2020. What was the approximate population in 2011? 2012? 2013? 2020?   Michigan Town Population    Year  2010  2011  2012  2013  2020    Population  5500           What is different about the population change from year to year in the small town in Indiana and the population change from year to year in the small town in Ohio?    What is different about the population change from year to year in the small town in Michigan and the population change from year to year in the small town in Ohio?        Jennifer owns a clothing store.    She wants to increase the price of a $15 shirt at her store by 60%. She performs the calculation two ways: . She gets the same result with each calculation. Explain why both methods work.    Jennifer has been selling a coat at her store for $125. She decides to have a \"30% off everything in the store\" sale. Using the previous question as a guide, write two math expressions which a customer could use to calculate the sale price of a coat.      In an expression of the form , we call the base , the exponent or power , and a coefficient . This vocabulary will be useful to us in the next lesson, so let's practice it now.    Identify the base, exponent, and coefficient in each of the expressions below.     Write an expression with base , coefficient , and exponent .     You'll need to be able to do the following things for this lesson. Rate how confident you are on a scale of 1 - 5 (1 = not confident and 5 = very confident).     Skill or Concept: I can …  Rating from 1 to 5    Apply the same percent change to a quantity repeatedly.     Write formulas for calculating the new value of quantity after a percent change in two different ways.     Identify the base, exponent, and coefficient in an expression of the form        "
},
{
  "id": "sec-exponential-models-prep-2-1",
  "level": "2",
  "url": "sec-exponential-models-prep.html#sec-exponential-models-prep-2-1",
  "type": "Prep Activity",
  "number": "4.3.1",
  "title": "",
...
{
  "id": "sec-exponential-models-prep-3-1",
  "level": "2",
  "url": "sec-exponential-models-prep.html#sec-exponential-models-prep-3-1",
  "type": "Prep Activity",
  "number": "4.3.2",
  "title": "",
  "body": "  Jennifer owns a clothing store.    She wants to increase the price of a $15 shirt at her store by 60%. She performs the calculation two ways: . She gets the same result with each calculation. Explain why both methods work.    Jennifer has been selling a coat at her store for $125. She decides to have a \"30% off everything in the store\" sale. Using the previous question as a guide, write two math expressions which a customer could use to calculate the sale price of a coat.   "
},
{
  "id": "sec-exponential-models-prep-3-2",
  "level": "2",
  "url": "sec-exponential-models-prep.html#sec-exponential-models-prep-3-2",
  "type": "Prep Activity",
  "number": "4.3.3",
  "title": "",
...
{
  "id": "sec-multivar-models",
  "level": "1",
  "url": "sec-multivar-models.html",
  "type": "Section",
  "number": "5.1",
  "title": "Multivariable Models",
  "body": " Multivariable Models     Resting energy expenditure (REE) is the rate at which your body burns calories when you're not exercising in order to fuel normal bodily processes like breathing, thinking, non-exercise movement, digesting food, etc. Calculating REE has an important role in medical care. Critically ill patients under hospital care must be provided with sufficient calories to cover their REE and other energy needs. A variety of equations have been used to predict REE in critically ill patients. Some of the equations used to predict REE in critically ill patients are shown below.  Many of the equations below use multiple variables to predict REE. Mathematical models that use more than one input variable to produce an output variable are called multivariable models .   American College of Chest Physicians equation:   Harris-Benedict equations   Men:  Women:    Penn State 1998 equation:  Penn State 2003 equation:   Notes about the variables in these equations:   is measured in calories per day.  is weight, measured in kilograms.  is height, measured in centimeters.  is age, measured in years.  is the maximum body temperature in the past 24 hours, measured in Celsius.  is a measure called minute volume , which is the volume of air that is inhaled and exhaled in one minute, measured in liters per minute. Normal levels are around 5 - 8 liters per minute.      Which variables in the equations above have a positive (increasing) effect on REE? Take a minute to think about this on your own before sharing your ideas in your group. Explain how you determined your answer.    Which variable in the equations above has a negative (decreasing) effect on REE? Take a minute to think about this on your own before sharing your ideas in your group. Explain how you determined your answer.    Use Devon's profile in the table below to do the calculations (i) - (iv). Round to the nearest calorie per day. Try each calculation on your own first before sharing your answers in your group.   Hint: Don't forget that, in the equations, weight is measured in kilograms, height is measured in centimeters, and temperature is measured in degrees Celsius. You'll need to know that , , and that a formula for converting from degrees Fahrenheit (F) to degrees Celsius (C) is .   Devon's Profile    Sex  Age  Weight  Height      Male  29  188 lbs  5 ft, 11 in  98.6 degrees F  7 L\/min      American College of Chest Physicians   Harris-Benedict   Penn State 1998   Penn State 2003    Suppose Camila and Sofia, who are female twins, want to calculate their REE using the Harris-Benedict equation.   Using the information in the table below, calculate the predicted REE for Camila and for Sofia. Do the calculations on your own before sharing your answers in your group.   Camila and Sofia's weight, height, and age.     Camila  Sofia    Weight (kg)  61  62    Height (cm)  165  165    Age (years)  30  30    Predicted REE        How much higher is Sofia's predicted REE than Camila's predicted REE? How does this relate to the coefficient for weight in the Harris-Benedict equation for females?   Interpret the coefficient for age in the Harris-Benedict equation for females.    Imagine that you have just completed a moderate 45-minute workout and decide to measure your REE. Which of the equations might be used to support the notion that working out can raise your REE?    How accurate do you think these formulas are?        Multivariable models can also have inputs with non-linear relationships to the output. An example is seen in a fundamental equation in physics for kinetic energy. Kinetic energy is the amount of energy an object has due to its motion. Think about an object moving toward you. The heavier the object and the faster it is moving, the more kinetic energy it has (the harder it will hit you). The equation for calculating kinetic energy is:   where  kinetic energy, measured in joules  mass of the object, in kilograms  speed of the object, in meters per second     To consider the importance of kinetic energy, imagine being hit by a tennis ball that is traveling 50 miles per hour (it would probably hurt). Now imagine being hit by an average sized car moving at 65 miles per hour. To quantify the difference, calculate the kinetic energy of the tennis ball and the car. Try this on your own first before sharing your answers in your group. Round to the nearest one hundredth of a joule. You will need:  Tennis balls have a mass of 58.5 grams.  An average sized car has a mass of 1500 kilograms.  To convert units: 1 kilogram = 1000 grams; 1 mile per hour ≈ 0.447 meters per second.     How many times greater is the car's kinetic energy compared to the tennis ball's kinetic energy? Round to the nearest whole number.    If we instead compare the kinetic energy of two average sized cars, Car 1 moving at 50 miles per hour and Car 2 moving at 25 miles per hour, how many times greater is the kinetic energy of Car 1 compared to Car 2?        Your friend Dash is helping you search for a good used car to buy. They researched three cars yesterday and rated each car on a scale of 1 to 10 (10 is the best, 1 is the worst) in four different categories. Dash's recommendations are shown in the table below. Dash recommended that you look at Car 3, because it has the highest average rating of the three cars.   Dash's Used Car Ratings     Car 1  Car 2  Car 3    Reliability  8  6  7    Gas Mileage  6  7  5    Interior Features\/Comfort  5  9  6    Cargo space  7  4  10    Mean (Average)  6.5  6.5  7       What do you observe about how the three cars compare to each other across all categories?    What is an explanation for why Car 3 has the highest overall mean (average)?    What are the advantages and disadvantages of using a mean (average) to select the best overall car?   One way to show that some categories are more important than others would be to count that rating more times. For example, if Reliability is important, you can count it twice; if Comfort is even more important, you can count it four times. Your ratings might now look like this:  Dash's Used Car Ratings     Car 1  Car 2  Car 3    Reliability  8  6  7    Reliability  8  6  7    Gas Mileage  6  7  5    Interior Features\/Comfort  5  9  6    Interior Features\/Comfort  5  9  6    Interior Features\/Comfort  5  9  6    Interior Features\/Comfort  5  9  6    Cargo space  7  4  10    Mean (Average)       Make a prediction for which car will have the highest overall rating and then calculate each average.   This kind of average, where some values are counted more times than others, is called a weighted average . The weights refer to how much each value is counted. In the above example, you could say that the categories of Gas Mileage and Cargo Space have weights equal to 1, Reliability has a weight of 2, and Interior Features\/Comfort has a weight of 4. So, the total number of weights is 8. (1 for Gas Mileage, 1 for Cargo Space, 2 for Reliability, 4 for Interior Features\/Comfort = 8 total weights.)  Weighted average problems are specific cases of multivariable models. You might notice that the categories for rating the cars are acting as input variables used to calculate an overall score for Car Quality (weighted average), which is the output variable.   Which of the following represents the multivariable model used to calculate the score for Car Quality (weighted average) in the previous problem? The following variables represent the individual rating in each category: = Reliability; = Gas Mileage; = Interior Features\/Comfort; = Cargo Space.         Devon suggests using a different weighting strategy. They agree with all of your preferences, but want to use bigger weights with the following formula:    What is the weight for the Interior Features\/Comfort category?   How many total weights are used in this equation?   Using the same ratings in each category from above, find the weighted average for each car using this new equation. How do these weighted averages compare to the earlier weighted averages? What could explain your results?   Imagine using this approach in choosing a car and create your own weighted average formula based on your own personal preferences. Use the same four categories: Reliability, Gas Mileage, Interior Features\/Comfort, and Cargo Space, but choose relative weights for each category based on what you think is important in a vehicle.   Write your weighted average formula.   Explain how you chose the weights for the different categories.   Use your formula to calculate the weighted average of each of the three cars.   Which car has the highest weighted average according to your weighting? Which car would be the best out of the three for you?        It was noted above that weighted average models are specific cases of multivariable models. There are many multivariable models that are not weighted average models, for example, the REE equations.  Consider the weighted average model from Question 12 and compare it to the Harris-Benedict equation for males' REE (both shown below).      What differences do you notice between the equations?    Why is the Harris-Benedict model for male REE not a weighted average?     "
},
{
  "id": "sec-multivar-models-2-1-1",
  "level": "2",
  "url": "sec-multivar-models.html#sec-multivar-models-2-1-1",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Resting energy expenditure (REE) "
},
{
  "id": "sec-multivar-models-2-1-2",
  "level": "2",
  "url": "sec-multivar-models.html#sec-multivar-models-2-1-2",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "multivariable models "
},
{
  "id": "sec-multivar-models-2-2",
  "level": "2",
  "url": "sec-multivar-models.html#sec-multivar-models-2-2",
  "type": "Activity",
  "number": "5.1.1",
  "title": "",
  "body": "  Which variables in the equations above have a positive (increasing) effect on REE? Take a minute to think about this on your own before sharing your ideas in your group. Explain how you determined your answer.    Which variable in the equations above has a negative (decreasing) effect on REE? Take a minute to think about this on your own before sharing your ideas in your group. Explain how you determined your answer.    Use Devon's profile in the table below to do the calculations (i) - (iv). Round to the nearest calorie per day. Try each calculation on your own first before sharing your answers in your group.   Hint: Don't forget that, in the equations, weight is measured in kilograms, height is measured in centimeters, and temperature is measured in degrees Celsius. You'll need to know that , , and that a formula for converting from degrees Fahrenheit (F) to degrees Celsius (C) is .   Devon's Profile    Sex  Age  Weight  Height      Male  29  188 lbs  5 ft, 11 in  98.6 degrees F  7 L\/min      American College of Chest Physicians   Harris-Benedict   Penn State 1998   Penn State 2003    Suppose Camila and Sofia, who are female twins, want to calculate their REE using the Harris-Benedict equation.   Using the information in the table below, calculate the predicted REE for Camila and for Sofia. Do the calculations on your own before sharing your answers in your group.   Camila and Sofia's weight, height, and age.     Camila  Sofia    Weight (kg)  61  62    Height (cm)  165  165    Age (years)  30  30    Predicted REE        How much higher is Sofia's predicted REE than Camila's predicted REE? How does this relate to the coefficient for weight in the Harris-Benedict equation for females?   Interpret the coefficient for age in the Harris-Benedict equation for females.    Imagine that you have just completed a moderate 45-minute workout and decide to measure your REE. Which of the equations might be used to support the notion that working out can raise your REE?    How accurate do you think these formulas are?   "
},
{
  "id": "sec-multivar-models-3-1",
  "level": "2",
  "url": "sec-multivar-models.html#sec-multivar-models-3-1",
  "type": "Activity",
  "number": "5.1.2",
  "title": "",
  "body": "  Multivariable models can also have inputs with non-linear relationships to the output. An example is seen in a fundamental equation in physics for kinetic energy. Kinetic energy is the amount of energy an object has due to its motion. Think about an object moving toward you. The heavier the object and the faster it is moving, the more kinetic energy it has (the harder it will hit you). The equation for calculating kinetic energy is:   where  kinetic energy, measured in joules  mass of the object, in kilograms  speed of the object, in meters per second     To consider the importance of kinetic energy, imagine being hit by a tennis ball that is traveling 50 miles per hour (it would probably hurt). Now imagine being hit by an average sized car moving at 65 miles per hour. To quantify the difference, calculate the kinetic energy of the tennis ball and the car. Try this on your own first before sharing your answers in your group. Round to the nearest one hundredth of a joule. You will need:  Tennis balls have a mass of 58.5 grams.  An average sized car has a mass of 1500 kilograms.  To convert units: 1 kilogram = 1000 grams; 1 mile per hour ≈ 0.447 meters per second.     How many times greater is the car's kinetic energy compared to the tennis ball's kinetic energy? Round to the nearest whole number.    If we instead compare the kinetic energy of two average sized cars, Car 1 moving at 50 miles per hour and Car 2 moving at 25 miles per hour, how many times greater is the kinetic energy of Car 1 compared to Car 2?   "
},
{
  "id": "sec-multivar-models-4-1",
  "level": "2",
  "url": "sec-multivar-models.html#sec-multivar-models-4-1",
  "type": "Activity",
  "number": "5.1.3",
  "title": "",
  "body": "  Your friend Dash is helping you search for a good used car to buy. They researched three cars yesterday and rated each car on a scale of 1 to 10 (10 is the best, 1 is the worst) in four different categories. Dash's recommendations are shown in the table below. Dash recommended that you look at Car 3, because it has the highest average rating of the three cars.   Dash's Used Car Ratings     Car 1  Car 2  Car 3    Reliability  8  6  7    Gas Mileage  6  7  5    Interior Features\/Comfort  5  9  6    Cargo space  7  4  10    Mean (Average)  6.5  6.5  7       What do you observe about how the three cars compare to each other across all categories?    What is an explanation for why Car 3 has the highest overall mean (average)?    What are the advantages and disadvantages of using a mean (average) to select the best overall car?   One way to show that some categories are more important than others would be to count that rating more times. For example, if Reliability is important, you can count it twice; if Comfort is even more important, you can count it four times. Your ratings might now look like this:  Dash's Used Car Ratings     Car 1  Car 2  Car 3    Reliability  8  6  7    Reliability  8  6  7    Gas Mileage  6  7  5    Interior Features\/Comfort  5  9  6    Interior Features\/Comfort  5  9  6    Interior Features\/Comfort  5  9  6    Interior Features\/Comfort  5  9  6    Cargo space  7  4  10    Mean (Average)       Make a prediction for which car will have the highest overall rating and then calculate each average.   This kind of average, where some values are counted more times than others, is called a weighted average . The weights refer to how much each value is counted. In the above example, you could say that the categories of Gas Mileage and Cargo Space have weights equal to 1, Reliability has a weight of 2, and Interior Features\/Comfort has a weight of 4. So, the total number of weights is 8. (1 for Gas Mileage, 1 for Cargo Space, 2 for Reliability, 4 for Interior Features\/Comfort = 8 total weights.)  Weighted average problems are specific cases of multivariable models. You might notice that the categories for rating the cars are acting as input variables used to calculate an overall score for Car Quality (weighted average), which is the output variable.   Which of the following represents the multivariable model used to calculate the score for Car Quality (weighted average) in the previous problem? The following variables represent the individual rating in each category: = Reliability; = Gas Mileage; = Interior Features\/Comfort; = Cargo Space.         Devon suggests using a different weighting strategy. They agree with all of your preferences, but want to use bigger weights with the following formula:    What is the weight for the Interior Features\/Comfort category?   How many total weights are used in this equation?   Using the same ratings in each category from above, find the weighted average for each car using this new equation. How do these weighted averages compare to the earlier weighted averages? What could explain your results?   Imagine using this approach in choosing a car and create your own weighted average formula based on your own personal preferences. Use the same four categories: Reliability, Gas Mileage, Interior Features\/Comfort, and Cargo Space, but choose relative weights for each category based on what you think is important in a vehicle.   Write your weighted average formula.   Explain how you chose the weights for the different categories.   Use your formula to calculate the weighted average of each of the three cars.   Which car has the highest weighted average according to your weighting? Which car would be the best out of the three for you?   "
},
{
  "id": "sec-multivar-models-5-1",
  "level": "2",
  "url": "sec-multivar-models.html#sec-multivar-models-5-1",
  "type": "Activity",
  "number": "5.1.4",
  "title": "",
...
},
{
  "id": "a-cube-root-law",
  "level": "2",
  "url": "sec-power-models.html#a-cube-root-law",
  "type": "Activity",
  "number": "5.2.2",
  "title": "",
...
},
{
  "id": "a-ree-mass",
  "level": "2",
  "url": "sec-power-models.html#a-ree-mass",
  "type": "Activity",
  "number": "5.2.3",
  "title": "",
...
},
{
  "id": "a-kepler-3rd-law",
  "level": "2",
  "url": "sec-power-models.html#a-kepler-3rd-law",
  "type": "Activity",
  "number": "5.2.4",
  "title": "",
...
},
{
  "id": "a-color-noise",
  "level": "2",
  "url": "sec-power-models.html#a-color-noise",
  "type": "Activity",
  "number": "5.2.5",
  "title": "",
...
{
  "id": "sec-quad-and-polyn",
  "level": "1",
  "url": "sec-quad-and-polyn.html",
  "type": "Section",
  "number": "5.3",
  "title": "Quadratic and Polynomial Models",
  "body": " Quadratic and Polynomial Models     Edna makes ceramic gnomes to sell at a local craft market each week. The cost of her ceramic-making equipment is $100 and the cost of supplies per gnome is $15. If the selling price per gnome is $50 then Edna will sell 28 gnomes per week but if she drops the price to $45 per gnome then she will sell 32 of them per week.    A price-demand function is a mathematical model the describes the relationship between the selling price of an item and the demand, i.e., the number of items sold. Let be the selling price for one of Edna's gnomes and be the number of gnomes Edna sells. Assume that the relationship between and is linear, and use the information given in the problem statement to find a linear model for the price-demand function for Edna's gnomes.    You should have found a negative slope for your price-demand function. Why does it make sense that the slope would be negative in this context? That is, why does it make sense that the price-demand function is decreasing?    Let be Edna's revenue , the amount of money that she takes in from selling gnomes. Explain why it makes sense that .    The model is a multivariable model for revenue. It's often useful to turn multivariable models into single variable models, when possible, because many of the mathematical tools we use to analyze models are simpler when there are fewer variables. We can get a model for revenue that includes only and (the number of items sold) by replacing with the price-demand function.  For example, Manuel sells handmade cutting boards at the craft fair. His price-demand function for his cutting boards is . That means his revenue is . Note: The parentheses are important! In order to find revenue, we need to multiply the number of items sold by the price of an item. If Manuel wrote his revenue model as , then his model would find number of items sold times 90, then subtract , instead of number of items sold times that price of the item (which is ).  Find a single variable model for Edna's revenue by replacing with your price-demand function.    Manuel's revenue model is kind of messy! He decides to clean it up using distribution. First, he uses the distributive property to rewrite . This gives him , which he simplifies by adding 90 and 34 to get . Finally, Manuel distributes the to get .  Use the distributive property to clean up your model for Edna's revenue.    What will Edna's revenue be is she sells 20 gnomes? 30 gnomes? 40 gnomes?    Use Desmos to create a graph for Edna's revenue. Sketch your graph here. What do you notice about the graph? What do you wonder?    Explain how you know that this model for revenue is not a linear, exponential, or power model.    Use Desmos and your graph to find the number of gnomes that Edna needs to sell in order to have revenue of exactly $1200. You should have two answers!    Try to find the number of gnomes that Edna needs to sell in order to have revenue of exactly $1200 using algebra instead of the graph. What problem(s) do you encounter? Or, what tool that we haven't discussed yet did you need to use?    Use Desmos and your graph to find the number of gnomes that Edna needs to sell in order to have revenue of at least $1200. Your answer should be a range of numbers!      The models we found for revenue in are polynomials . A polynomial model can be written as a sum of nonnegative whole number powers of a variable times constants. In formal symbols, we can write a polynomial in the form for some nonegative whole number and numbers . The numbers that are multiplied by the variable and its powers are called coefficients.   The highest power in a polynomial is called the degree of the polynomial. The leading coefficient is the coefficient of the highest power. A polynomial of degree 2 is also called a quadratic model.    Decide whether or not each of the expressions below is a polynomial. Briefly explain your answers.                            What are the degrees and leading coefficients of the expressions from that were polynomial?    Are any of the expressions in quadratic models?    Is a linear model a polynomial? Explain your answer.    Are power models polynomials? Explain your answer.    Write a list of features that tell you that an expression is NOT a polynomial.      Pablo and Aisha are designing custom boxes to use at a special event. Attendees will fill their boxes with candy from a candy bar They'll make the boxes out of inch cardstock that they've had printed with their club's logo and advertisements. In this activity, you'll help Pablo and Aisha figure out how to build a box that will hold the most candy possible.  The diagram below shows how Pablo and Aisha are going to make their boxes. They'll cut out the corner squares, then fold up the four edge rectangles. The center rectangle will be the bottom of the box.   Template for building a box.    Squares with side length have been cut out of all four corners of an inch rectangle. The bottom edge of the center rectangle is labeled length, and the left edge of the center rectangle is labeled width.   Box template      Explain why is the height of the box.   Find formulas for the length and width of the box.    Find a formula for the volume of the box.    Use your formula to find the volume of the box for three different values of . (You choose the values of ).    Use Desmos to make graph your volume formula, and sketch your graph here.    Use Desmos and your graph to find the value of that gives Pablo and Aisha the box with the biggest volume.     Algebra Challenge: Use the distributive property to rewrite your volume formula without any parentheses!      In , we looked at Edna's small business selling ceramic gnomes at craft fairs. In that activity, we explored her revenue. Edna is more interested in her profit than her revenue. Profit is the amount of money that she's made after subtracting her costs from her revenue.    Use the information given in to find a model for Edna's costs, , to produce gnomes. Additionally, explain how we know that a linear model is appropriate.    You should have found a positive slope for your cost model. Why does it make sense that the slope would be positive in this context? That is, why does it make sense that the cost model is increasing?    Let be Edna's profit. Profit is revenue minus costs. Use your revenue model from and your cost model to find a model for profit.    Is your profit model any of: linear, exponential, power, quadratic, or polynomial? Explain how you know.    Use Desmos to graph your profit model, and sketch your graph here. What do you notice? What do you wonder?    Use Desmos and your graph to determine how many gnomes Edna needs to sell in order to at least breakeven, i.e., in order to have a profit of $0 or higher. Your answer should be a range of numbers!    Use Desmos and your graph to determine how many gnomes Edna needs to sell in order to maximize her profit.    Use your price-demand function from to determine the range of prices that Edna should consider for her gnomes in order to at least breakeven, and the price that will give her the highest profit.      In , you helped Pablo and Aisha build a box out of cardstock with the largest volume possible. At the event, Pablo noticed that most people didn't just fill their box to the top, but piled up candy up higher than the top of the box. He and Aisha want to reconsider their box design to take into account this additional candy. They want to maximize the volume, including not only the box but also the pile on top.    Is the length or width of the box going to be smaller? How do you know?    Pablo thinks that most people's extra candy pile was roughly pyramid-shaped. The base of the period is the rectangular opening at the top of the box. Find a formula for the area of the base.    Pablo thinks the height of most people's pyramid of candy was about a quarter of the shorterst side of the base. Find a formula for the height of the pyramid.    The volume of a pyramid is . Find a formula for the volume of the pyramid.    Find a formula for the total volume of candy by adding your formula for the volume of the box from and your formula for the volume of the pyramid.    What should be in order to make the total volume as large as possible? Hint: Use Desmos to help you answer this question.    "
},
{
  "id": "a-price-demand-revenue",
  "level": "2",
  "url": "sec-quad-and-polyn.html#a-price-demand-revenue",
  "type": "Activity",
  "number": "5.3.1",
  "title": "",
  "body": "  Edna makes ceramic gnomes to sell at a local craft market each week. The cost of her ceramic-making equipment is $100 and the cost of supplies per gnome is $15. If the selling price per gnome is $50 then Edna will sell 28 gnomes per week but if she drops the price to $45 per gnome then she will sell 32 of them per week.    A price-demand function is a mathematical model the describes the relationship between the selling price of an item and the demand, i.e., the number of items sold. Let be the selling price for one of Edna's gnomes and be the number of gnomes Edna sells. Assume that the relationship between and is linear, and use the information given in the problem statement to find a linear model for the price-demand function for Edna's gnomes.    You should have found a negative slope for your price-demand function. Why does it make sense that the slope would be negative in this context? That is, why does it make sense that the price-demand function is decreasing?    Let be Edna's revenue , the amount of money that she takes in from selling gnomes. Explain why it makes sense that .    The model is a multivariable model for revenue. It's often useful to turn multivariable models into single variable models, when possible, because many of the mathematical tools we use to analyze models are simpler when there are fewer variables. We can get a model for revenue that includes only and (the number of items sold) by replacing with the price-demand function.  For example, Manuel sells handmade cutting boards at the craft fair. His price-demand function for his cutting boards is . That means his revenue is . Note: The parentheses are important! In order to find revenue, we need to multiply the number of items sold by the price of an item. If Manuel wrote his revenue model as , then his model would find number of items sold times 90, then subtract , instead of number of items sold times that price of the item (which is ).  Find a single variable model for Edna's revenue by replacing with your price-demand function.    Manuel's revenue model is kind of messy! He decides to clean it up using distribution. First, he uses the distributive property to rewrite . This gives him , which he simplifies by adding 90 and 34 to get . Finally, Manuel distributes the to get .  Use the distributive property to clean up your model for Edna's revenue.    What will Edna's revenue be is she sells 20 gnomes? 30 gnomes? 40 gnomes?    Use Desmos to create a graph for Edna's revenue. Sketch your graph here. What do you notice about the graph? What do you wonder?    Explain how you know that this model for revenue is not a linear, exponential, or power model.    Use Desmos and your graph to find the number of gnomes that Edna needs to sell in order to have revenue of exactly $1200. You should have two answers!    Try to find the number of gnomes that Edna needs to sell in order to have revenue of exactly $1200 using algebra instead of the graph. What problem(s) do you encounter? Or, what tool that we haven't discussed yet did you need to use?    Use Desmos and your graph to find the number of gnomes that Edna needs to sell in order to have revenue of at least $1200. Your answer should be a range of numbers!   "
},
{
  "id": "a-polyn-vocab",
  "level": "2",
  "url": "sec-quad-and-polyn.html#a-polyn-vocab",
  "type": "Activity",
  "number": "5.3.2",
  "title": "",
  "body": "  The models we found for revenue in are polynomials . A polynomial model can be written as a sum of nonnegative whole number powers of a variable times constants. In formal symbols, we can write a polynomial in the form for some nonegative whole number and numbers . The numbers that are multiplied by the variable and its powers are called coefficients.   The highest power in a polynomial is called the degree of the polynomial. The leading coefficient is the coefficient of the highest power. A polynomial of degree 2 is also called a quadratic model.    Decide whether or not each of the expressions below is a polynomial. Briefly explain your answers.                            What are the degrees and leading coefficients of the expressions from that were polynomial?    Are any of the expressions in quadratic models?    Is a linear model a polynomial? Explain your answer.    Are power models polynomials? Explain your answer.    Write a list of features that tell you that an expression is NOT a polynomial.   "
},
{
  "id": "a-build-a-box",
  "level": "2",
  "url": "sec-quad-and-polyn.html#a-build-a-box",
  "type": "Activity",
  "number": "5.3.3",
  "title": "",
  "body": "  Pablo and Aisha are designing custom boxes to use at a special event. Attendees will fill their boxes with candy from a candy bar They'll make the boxes out of inch cardstock that they've had printed with their club's logo and advertisements. In this activity, you'll help Pablo and Aisha figure out how to build a box that will hold the most candy possible.  The diagram below shows how Pablo and Aisha are going to make their boxes. They'll cut out the corner squares, then fold up the four edge rectangles. The center rectangle will be the bottom of the box.   Template for building a box.    Squares with side length have been cut out of all four corners of an inch rectangle. The bottom edge of the center rectangle is labeled length, and the left edge of the center rectangle is labeled width.   Box template      Explain why is the height of the box.   Find formulas for the length and width of the box.    Find a formula for the volume of the box.    Use your formula to find the volume of the box for three different values of . (You choose the values of ).    Use Desmos to make graph your volume formula, and sketch your graph here.    Use Desmos and your graph to find the value of that gives Pablo and Aisha the box with the biggest volume.     Algebra Challenge: Use the distributive property to rewrite your volume formula without any parentheses!   "
},
{
  "id": "a-profit",
  "level": "2",
  "url": "sec-quad-and-polyn.html#a-profit",
  "type": "Activity",
  "number": "5.3.4",
  "title": "",
  "body": "  In , we looked at Edna's small business selling ceramic gnomes at craft fairs. In that activity, we explored her revenue. Edna is more interested in her profit than her revenue. Profit is the amount of money that she's made after subtracting her costs from her revenue.    Use the information given in to find a model for Edna's costs, , to produce gnomes. Additionally, explain how we know that a linear model is appropriate.    You should have found a positive slope for your cost model. Why does it make sense that the slope would be positive in this context? That is, why does it make sense that the cost model is increasing?    Let be Edna's profit. Profit is revenue minus costs. Use your revenue model from and your cost model to find a model for profit.    Is your profit model any of: linear, exponential, power, quadratic, or polynomial? Explain how you know.    Use Desmos to graph your profit model, and sketch your graph here. What do you notice? What do you wonder?    Use Desmos and your graph to determine how many gnomes Edna needs to sell in order to at least breakeven, i.e., in order to have a profit of $0 or higher. Your answer should be a range of numbers!    Use Desmos and your graph to determine how many gnomes Edna needs to sell in order to maximize her profit.    Use your price-demand function from to determine the range of prices that Edna should consider for her gnomes in order to at least breakeven, and the price that will give her the highest profit.   "
},
{
  "id": "a-build-a-box-2",
  "level": "2",
  "url": "sec-quad-and-polyn.html#a-build-a-box-2",
  "type": "Activity",
  "number": "5.3.5",
  "title": "",
...
{
  "id": "sec-quad-and-polyn-prep",
  "level": "1",
  "url": "sec-quad-and-polyn-prep.html",
  "type": "Section",
  "number": "6.3",
  "title": "Quadratic and Polynomial Models Prep Activities",
  "body": " Quadratic and Polynomial Models Prep Activities     Use the provided formulas to find the area or volume of the shape. You will need to decide which formula or formulas to use!   Area of a rectangle:   Length and width of a rectangle    Rectangle with length and width labeled   Rectangle      Area of a triangle:   Base and height of a triangle    Triangles with base and height labeled   Triangles      Area of a circle:   Radius of a circle    Circle with radius   Circle      Volume of a box:   Length, width, and height of a box    Box with length, width, and height   Box      Volume of a pyramid:   Base and height of a pyramid    Pyramid with base and height   Pyramid          Circle with radius 2 cm    Circle with radius 2 cm   Circle with radius 2 cm       The shaded area. Hint: You'll need to use the area of a rectangle formula twice.   Area of a frame    Rectangle with length 1 and width 2, inside of a rectangle with length 4 and width 3. The area to find is the area between the rectangles   Rectangular frame        Composite shape made up of a square with side length 2, a triangle with base 2 and height 3, and a half of a circle with radius 1    Composite shape made up of a square with side length 2, a triangle with base 2 and height 3, and a half of a circle with radius 1   Composite shape       Volume of a box with length 3, width 7, and height 2.    Volume of a period with base a rectangle with length 2 and width 4, and height of 1.5.      The distributive property lets us rewrite multiplication of expressions in the form without parentheses. The distributive property says . Some people find it helpful to represent the distributive property as finding the area of a rectangle in two ways:   Visualizing the Distributive Property    The distributive property can be visualized as two ways to find the area of a rectangle with length and width . One way is to multiply the length and the width to get . The second way is to view the rectangle as two smaller rectangles, then add the areas of those rectangles to get .   Distributive Property Visual       Multiply the length and the width to get .   Split the big rectangle into two little rectangles. Find the areas of the little rectangles and add them to get the area of the big rectangle.   For example, using the distributive property to rewrite the expression gives us . We can visualize this using the diagram below.   An Example of the Distributive Property    A large rectangle with width 2 and length split into two pieces. The first piece of the length is 5, and the second piece is . So, the large rectangle is made up of a small rectangle with width 2 and length 5 and a second small rectangle of width 2 and length . The area of the first small rectangle is and the area of the second small rectangle is . So, the area of the big rectangle is 10 - 6x.   Distributive Property Visual     Use the distributive property to rewrite each of the expressions below.                    (Hint: Extend the area model so that the big rectangle is made up of 3 smaller rectangles.)      The distributive property also lets us rewrite multiplication of expressions in the form without parentheses. The distributive property says . The area model can also be helpful for this version of the distributive property.   Visualizing the Distributive Property, Part 2    The distributive property can be visualized as two ways to find the area of a rectangle with length and width . One way is to multiply the length and the width to get . The second way is to view the rectangle as four smaller rectangles, then add the areas of those rectangles to get .   Distributive Property Visual, Part 2     For example, using the distributive property to rewrite the expression gives us . We can visualize this using the diagram below.   An Example of the Distributive Property, Part 2    A large rectangle split in half both horizontally and vertically, to form four small rectangles inside the large rectangle. The halves of the vertical are labeled and 4. The halves of the horizontal are labeled 5 and . The upper left rectangle has area , the upper right rectangle has area , the lower left rectangle has area , and the lower right rectangle has area .   Distributive Property Visual Example 2     Use the distributive property to rewrite each of the expressions below.                    You'll need to be able to do the following things for this lesson. Rate how confident you are on a scale of 1 - 5 (1 = not confident and 5 = very confident).     Skill or Concept: I can …  Rating from 1 to 5    Use formulas to find areas and volumes.     Distribute to rewrite expressions of the form without parentheses.     Distribute to rewrite expressions of the form without parentheses.        "
},
{
  "id": "pa-area-volume-formulas",
  "level": "2",
  "url": "sec-quad-and-polyn-prep.html#pa-area-volume-formulas",
  "type": "Prep Activity",
  "number": "6.3.1",
  "title": "",
  "body": "  Use the provided formulas to find the area or volume of the shape. You will need to decide which formula or formulas to use!   Area of a rectangle:   Length and width of a rectangle    Rectangle with length and width labeled   Rectangle      Area of a triangle:   Base and height of a triangle    Triangles with base and height labeled   Triangles      Area of a circle:   Radius of a circle    Circle with radius   Circle      Volume of a box:   Length, width, and height of a box    Box with length, width, and height   Box      Volume of a pyramid:   Base and height of a pyramid    Pyramid with base and height   Pyramid          Circle with radius 2 cm    Circle with radius 2 cm   Circle with radius 2 cm       The shaded area. Hint: You'll need to use the area of a rectangle formula twice.   Area of a frame    Rectangle with length 1 and width 2, inside of a rectangle with length 4 and width 3. The area to find is the area between the rectangles   Rectangular frame        Composite shape made up of a square with side length 2, a triangle with base 2 and height 3, and a half of a circle with radius 1    Composite shape made up of a square with side length 2, a triangle with base 2 and height 3, and a half of a circle with radius 1   Composite shape       Volume of a box with length 3, width 7, and height 2.    Volume of a period with base a rectangle with length 2 and width 4, and height of 1.5.   "
},
{
  "id": "pa-distribute",
  "level": "2",
  "url": "sec-quad-and-polyn-prep.html#pa-distribute",
  "type": "Prep Activity",
  "number": "6.3.2",
  "title": "",
  "body": "  The distributive property lets us rewrite multiplication of expressions in the form without parentheses. The distributive property says . Some people find it helpful to represent the distributive property as finding the area of a rectangle in two ways:   Visualizing the Distributive Property    The distributive property can be visualized as two ways to find the area of a rectangle with length and width . One way is to multiply the length and the width to get . The second way is to view the rectangle as two smaller rectangles, then add the areas of those rectangles to get .   Distributive Property Visual       Multiply the length and the width to get .   Split the big rectangle into two little rectangles. Find the areas of the little rectangles and add them to get the area of the big rectangle.   For example, using the distributive property to rewrite the expression gives us . We can visualize this using the diagram below.   An Example of the Distributive Property    A large rectangle with width 2 and length split into two pieces. The first piece of the length is 5, and the second piece is . So, the large rectangle is made up of a small rectangle with width 2 and length 5 and a second small rectangle of width 2 and length . The area of the first small rectangle is and the area of the second small rectangle is . So, the area of the big rectangle is 10 - 6x.   Distributive Property Visual     Use the distributive property to rewrite each of the expressions below.                    (Hint: Extend the area model so that the big rectangle is made up of 3 smaller rectangles.)   "
},
{
  "id": "pa-distribute-2",
  "level": "2",
  "url": "sec-quad-and-polyn-prep.html#pa-distribute-2",
  "type": "Prep Activity",
  "number": "6.3.3",
  "title": "",
  "body": "  The distributive property also lets us rewrite multiplication of expressions in the form without parentheses. The distributive property says . The area model can also be helpful for this version of the distributive property.   Visualizing the Distributive Property, Part 2    The distributive property can be visualized as two ways to find the area of a rectangle with length and width . One way is to multiply the length and the width to get . The second way is to view the rectangle as four smaller rectangles, then add the areas of those rectangles to get .   Distributive Property Visual, Part 2     For example, using the distributive property to rewrite the expression gives us . We can visualize this using the diagram below.   An Example of the Distributive Property, Part 2    A large rectangle split in half both horizontally and vertically, to form four small rectangles inside the large rectangle. The halves of the vertical are labeled and 4. The halves of the horizontal are labeled 5 and . The upper left rectangle has area , the upper right rectangle has area , the lower left rectangle has area , and the lower right rectangle has area .   Distributive Property Visual Example 2     Use the distributive property to rewrite each of the expressions below.                  "
},
{
  "id": "pa-quad-polyn-prep-confidence",
  "level": "2",
  "url": "sec-quad-and-polyn-prep.html#pa-quad-polyn-prep-confidence",
  "type": "Prep Activity",
  "number": "6.3.4",
  "title": "",
  "body": " You'll need to be able to do the following things for this lesson. Rate how confident you are on a scale of 1 - 5 (1 = not confident and 5 = very confident).     Skill or Concept: I can …  Rating from 1 to 5    Use formulas to find areas and volumes.     Distribute to rewrite expressions of the form without parentheses.     Distribute to rewrite expressions of the form without parentheses.      "
...
{
  "id": "pa-quad-eqns-standard-form",
  "level": "2",
  "url": "sec-quad-algebra-prep.html#pa-quad-eqns-standard-form",
  "type": "Prep Activity",
  "number": "6.4.1",
  "title": "",
...
{
  "id": "pa-quad-eqns-b-zero",
  "level": "2",
  "url": "sec-quad-algebra-prep.html#pa-quad-eqns-b-zero",
  "type": "Prep Activity",
  "number": "6.4.2",
  "title": "",
...
{
  "id": "pa-quad-algebra-prep-confidence",
  "level": "2",
  "url": "sec-quad-algebra-prep.html#pa-quad-algebra-prep-confidence",
  "type": "Prep Activity",
  "number": "6.4.3",
  "title": "",
