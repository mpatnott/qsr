...
},
{
  ...
  "number": "2.2.1",
  "title": "",
  "body": "  Let's review plotting points. Use the axes below for all parts of this activity.   Money Earned    Blank axes. The horizontal axis is labeled , hrs and ranges from 0 to 40. The vertical axis is labeled $ and ranges from 0 to 400.   Blank axes.       If we're given the coordinates of a point, then we graph the point by going over to the first coordinate on the horizontal axis, and then up or down to the second number on the vertical axis. Graph the points , . You'll need to estimate the location of 25 on the horizontal axis.    In this class, we will often need to find the coordinates of a point from a sentence. For example, the sentence  Jakai will make $200 if he works for 25 hours.  describes that point on our graph. We know that 25 hours has to be the first\/horizontal coordinate because of the labeling of the axes in our graph.  Graph the points described by each of the following sentences:   Dior will make $300 if she works for 30 hours.   Santos worked for 10 hours and made $240.   Ramona worked for 35 hours and made $370.    We will sometimes be given points in a data table. Tables might be organized vertically, with named columns, or horizontally, with named rows. Look for the row and column names to find the horizontal and vertical coordinates of the points. Here are the points we've already graphed, arranged in a table in two different ways.    Points arranged in a vertical table    Hours Worked  Money Earned ($)    10  100    25  200    30  300    10  240    35  370      Points arranged in a vertical table    Hours Worked  10  25  30  10  35    Money Earned ($)  100  200  300  240  370      Add the points from the table below to the graph.   New points to graph    Hours Worked  15  20    Money Earned ($)  180  320       Write a sentence explaining why it doesn't make sense to connect these points in this context.   "
},
{
