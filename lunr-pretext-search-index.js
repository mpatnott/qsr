...
},
{
  ...
  "number": "2.3",
  "title": "Linear Trends",
  "body": " Linear Trends    In the real world, it is more common to have data that is approximately linear than exactly linear. These activities will introduce the idea of linear trends, which we'll spend more time in class. They'll also provide practice with building a linear model by identifying its slope and vertical intercept.     Several years ago, Onondaga Community College, in upstate New York, introduced a meal plan that included \"Flex Dollars\" that were stored on students' ID cards. The following description of flex dollars appeared on the college's website:   To accommodate instances where you do not wish to purchase a \"meal\", but would still like something to eat or drink, the College offers $150 of \"Flex Dollars\" included in each meal plan package. This \"flexible money\" may be used just like cash for any item sold in the Gordon Café, Mawhinney Café, Starbucks or Fresh Express. Do you want that Large Mocha at Starbucks or that pint of Ben and Jerry's from Mawhinney Café? Use your flex dollars to pay for it!   Onondaga student Loralee tracked her use of flex dollars weekly during the fall semester as shown in the table below:    Loralee's Flex Dollars Balance    Week  Balance ($)    0  150.00    1  146.75    2  142.75    3  139.00    4  134.00    5  130.25    6  126.25    7  122.25    8  118.50    9  114.50    10  110.00    11  106.50    12  101.50    13  97.00    14  93.25      Loralee's Flex Dollars Balance    Blank axes. The horizontal axis is labeled Week and ranges from 0 to 14. The vertical axis is labeled $ and ranges from 90 to 155.   Blank axes.        Make a graph of the amount of money left on Loralee's card over the semester.    This model is approximately linear. What are the units for the slope: $, Week\/$, $\/Week, or there are no units.    What is the vertical intercept tell you in context? the horizontal intercept?    Let be the amount of money left on the card, weeks after the beginning of the semester. Write a linear equation to model the data. Use Week 0 and Week 14 to calculate the slope.    If Loralee continues to spend her flex dollars at the same rate, use your euqation to determine how much money will be on the card at the end of spring semester, which also lasts 14 weeks.     "
},
{
