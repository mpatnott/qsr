...
},
{
  ...
  "number": "1.3",
  "title": "Linear Models",
  "body": " Linear Models     Xcel Energy provides electricity to most people in and around Denver Colorado. The table below shows an estimate of monthly rates charged by Xcel . Use this table to respond to the questions below.   Xcel Energy Electricity Charges, Residential Opt-Out Pricing     Summer Billing Cycles (June - Septembr)  Winter Billing Cycles    Fixed Monthly Fees  $12.20  $12.20    $ Per kWh  $0.1038  $0.0857       Suppose Iris uses no electricity in July. What would her monthly bill be?    Ellie uses 900 kWh in July. What would her monthly bill be?    David uses 905 kWh in July. What would his monthly bill be?    Use your answers to parts - to fill in the table below. What do you notice?   Average Rates of Change Between Summer Bills     Average Rate of Change    Iris and Ellie     Iris and David     David and Ellie        Sketch a graph that shows the relationship between kWh used in the summer and a customer's bill.  Hint: Start by graphing the three points you found in parts - !    Relationship between Bill and Electricity Usage    Blank axes. The horizontal axis is labeled kWh and ranges from 0 to 1500. The vertical axis is labeled $ and ranges from 0 to 170.   Blank axes.           A mathematical model that has a constant rate of change is called linear model . The rate of change of a linear model is called its slope .    Decide whether each of the three data sets fits a linear model. Explain your answers in words. If a data set does define a linear model, find its slope.   Data Set 1    Input  Output    -4  -4    -2  2    0  8    2  14    4  20      Data Set 2    Input  Output    10  2    20  10    40  26    80  58    160  122      Data Set 3    Input  Output    -5  3    0  4.5    5  7.5    10  12    15  18          Look back at your graph in part       daily latte problem from quantway co-req m.2    given a graph, do lines stuff    comparing data plans problem from quantway co-req m.4    develop point-slope form   "
},
{
...
},
{
  ...
  "number": "1.3.3",
  "title": "",
  "body": "   Look back at your graph in part    "
},
{
